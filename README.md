...
- マルチカンパニーとは、複数の会社・拠点を1つの基盤で分離管理しながら一元運用できる方式です。
- マルチテナント構成により、拠点や子会社ごとに個別サーバーを準備・構築する必要がなく、導入負荷を軽減できます。
- 共通基盤で運用を標準化できるため、インフラ費用・保守運用費・管理工数の削減につながります。
...
![個別発行画面](static/Image2026-03-05-10-30-41.png)
...
![一括メール送信画面](static/Image2026-03-05-10-33-46.png)
...
以下はテスト用のリンクです。なお、一部機能は現在開発中です。

https://github.com/Jerry-Chow/ZKBioTime/releases/tag/Beta
